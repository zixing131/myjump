!function(t) {
    try {
        t.MIDIjs = new Object,
        t.MIDIjs.initError = "initializing ...";
        var n, s, l, u, r, d, c = 6, m = null, p = 0, o = 32768, f = 8192, g = 0, a = 0, I = 0, b = !1, M = "", w = -1, j = "", y = !1, v = 0, h = !1, _ = 100, D = null, A = null, k = "libtimidity-for-worklet.js?v=" + c, x = null, O = new Array, C = 440, E = new Int32Array(128), T = Math.pow(2, 1 / 12);
        function R(e) {
            var t = 0;
            return void 0 !== e && (!0 === e ? t = -1 : !isNaN(e) && 0 < e && (t = e)),
            t
        }
        var N = !1;
        function q(e, t) {
            for (var n = 0; n < document.scripts.length; n++) {
                ...
                if (ce == r) {
                    ...
                    return newjs.onreadystatechange = function() {
                        "loaded" !== newjs.readyState && "complete" !== newjs.readyState || (newjs.onreadystatechange = null,
                        N = !0,
                        o(),
                        t())
                    }
        ...
        function P(e) {
            if (!I || !b)
                return Y("process(): No song started, returning true"),
                !0;
            if (0 == (a = Module.ccall("mid_song_read_wave", "number", ["number", "number", "number", "number"], [I, s, 2 * f, y])))
                return Y("Reached end of song"),
                U(),
                void (b = !1);
            for (var t = 0; t < f; t++)
                e.outputBuffer.getChannelData(0)[t] = t < a / 2 ? Module.getValue(s + 2 * t, "i16") / o : 0;
            -1 == w && (w = m.currentTime)
        }
        function W() {
            var e = new Object;
        ...
        function H(e) {
            m || (window.AudioContext = window.AudioContext || window.webkitAudioContext,
            m = new AudioContext),
        ...
        function F(e, t, n) {
            ...
            if (I = Module.ccall("mid_song_load", "number", ["number", "number"], [r, t]),
            rval = Module.ccall("mid_istream_close", "number", ["number"], [r]),
            0 < (g = Module.ccall("mid_song_get_num_missing_instruments", "number", ["number"], [I])))
                for (var o = 0; o < g; o++) {
                    ...
                    !function(n, r, o) {
                        ...
                        a.onload = function() {
                            ...
                            0 == g && (e = Module.ccall("mid_istream_open_mem", "number", ["number", "number", "number"], [l, u.length, !1]),
                            t = Module.ccall("mid_create_options", "number", ["number", "number", "number", "number"], [m.sampleRate, 32784, 1, 2 * f]),
                            ...
                            Y("Playing1: " + n + " ... song: " + I))) : Y("Error: Cannot retrieve patch file " + r + o + " : " + a.status)
                        }
                        ,
                        a.send()
                    }(e, M + "pat/", a)
        ...
        function X(e, t) {
            ...
            e ? (e.lastChild.setAttribute("src", url),
            e.lastChild.setAttribute("loop", t)) : ((e = document.createElement("div")).setAttribute("id", "scorioMIDI"),
            e.innerHTML = '&nbsp;<bgsound src="' + url + '" loop="' + t + '" volume="0"/>',
        ...
        function J() {
            p && (p.lastChild.setAttribute("src", G(M) + "../midi/silence.mid"),
            clearInterval(d),
            p = 0),
            Y(j)
        }
        function K() {
            var e;
            p && ((e = p).parentNode.removeChild(e),
            clearInterval(d),
            p = 0),
            Y(j)
        }
        function Q(e, t, n) {
            ...
            var o = Module.ccall("mid_istream_open_mem", "number", ["number", "number", "number"], [r, t.length, !1])
              ...
              , o = (Module.ccall("mid_istream_close", "number", ["number"], [o]),
            Module.ccall("mid_song_get_total_time", "number", ["number"], [t]) / 1e3);
                    ...
                    D.port.onmessage = function(e) {
                        ...
                        "get-patches" == n.type) {
                            ...
                            if (0 == (g = t.length)) {
                                ...
                                Y("Start playing " + i),
                                s && s(),
                                MIDIjs.message_callback && MIDIjs.message_callback("Now playing " + i)
                            } else
                            ...
                            "song-finished" == n.type ? (a.disconnect(),
                            clearInterval(d),
                            setTimeout(function() {
                                var e, t;
                                MIDIjs.player_callback && (e = n.duration,
        ...
        function ee(o, a, i) {
            ...
            12 == (240 & o) >> 4 ? V(M + "../midi/init.midi?v=" + c, function(e, t, n) {
                ...
                r.b = i,
                A.port.postMessage(r)
            }, function() {}) : ((e = new Object).type = "midi-message",
            e.status = o,
            e.a = a,
            e.b = i,
        ...
        function te(e, t, n) {
            A || ne(),
            "suspended" === m.state ? m.resume().then(function() {
                x.then(function() {
                    ee(e, t, n)
                })
            }) : x.then(function() {
        ...
        function ne(e) {
            var a;
            A || (m || (window.AudioContext = window.AudioContext || window.webkitAudioContext,
            m = new AudioContext),
            a = null,
            ...
            m.audioWorklet.addModule(M + k).then(function() {
                ...
                A.port.onmessage = function(e) {
                    ...
                    "get-patches" == t.type) {
                        ...
                        "song-finished" == t.type ? a() : Y("Error. Unkown request from expanderAudioWorket: ", t)
                }
                ,
        ...
        function re(t, n, r, o, a) {
            ...
            i.onload = function() {
                ...
                Y("Instruments to be loaded: " + g),
                0 == g && ((e = new Object).type = "prepare-player",
                e.url = n,
                e.midiDataArray = u,
                e.sampleRate = m.sampleRate,
                e.isEndless = a,
                e.looping = v,
                t.port.postMessage(e))) : Y("Error: Cannot retrieve patch file " + r + o + " : " + i.status)
            }
            ,
            i.send()
        }
        ...
        function ue(t, n) {
            m.audioWorklet.addModule(M + k).then(function() {
                ...
                o.port.onmessage = function(e) {
                    ...
                    "duration" == e.type ? n && n(e.duration) : "finished" == e.type || Y("Error. Unkown request from worklet: " + e.type)
                }
                ,
                V(t, function(e, t, n) {
                    Y("Got MIDI data from URL: " + e);
        ...
        -1 != (ge = Ie.indexOf("Opera")) ? (be = "Opera",
        Me = Ie.substring(ge + 6),
        -1 != (ge = Ie.indexOf("Version")) && (Me = Ie.substring(ge + 8))) : -1 != (ge = Ie.indexOf("MSIE")) ? (be = "Microsoft Internet Explorer",
        Me = Ie.substring(ge + 5)) : -1 != (ge = Ie.indexOf("Trident")) ? (be = "Microsoft Internet Explorer",
        Me = -1 != (ge = Ie.indexOf("rv:")) ? Ie.substring(ge + 3) : "0.0") : -1 != (ge = Ie.indexOf("Chrome")) ? (be = "Chrome",
        Me = Ie.substring(ge + 7)) : -1 != (ge = Ie.indexOf("Android")) ? (be = "Android",
        Me = Ie.substring(ge + 8)) : -1 != (ge = Ie.indexOf("Safari")) ? (be = "Safari",
        Me = Ie.substring(ge + 7),
        -1 != (ge = Ie.indexOf("Version")) && (Me = Ie.substring(ge + 8))) : -1 != (ge = Ie.indexOf("Firefox")) ? (be = "Firefox",
        Me = Ie.substring(ge + 8)) : (fe = Ie.lastIndexOf(" ") + 1) < (ge = Ie.lastIndexOf("/")) && (be = Ie.substring(fe, ge),
        ...
        we = parseInt("" + Me, 10),
        isNaN(we) && (Me = "" + parseFloat(navigator.appVersion),
        we = parseInt(navigator.appVersion, 10)),
        ...
        Ie);
        try {
            ("iPhone" == me.platform || "iPod" == me.platform || "iPad" == me.platform) && me.majorVersion <= 6 ? n = "none" : (window.AudioContext = window.AudioContext || window.webkitAudioContext,
            m = new AudioContext,
            n = "WebAudioAPI",
            null != m.audioWorklet && (n = "WebAudioWorklet",
        ...
        ,
        "WebAudioWorklet" == n ? (t.MIDIjs.get_duration = ue,
            ...
            if (Array.isArray(e))
                if (128 == e.length)
                    ...
                    if (!Array.isArray(e) || 12 != e.length)
                        return console.warn("Ignoring unknown frequency table. Must be array[12] or array[128]"),
                        !1;
                    oe(E, e)
                }
                ...
                if ((void 0 === o || isNaN(o) || o < 0 || 11 < o) && (o = 0),
                "detuned" == r)
                    for (t = 0; t < 128; t++) {
                    ...
                    if ("werckmeister" != r)
                        return console.warn("Ignoring unknown frequency table: ", e),
                        !1;
                    r = new Array(12);
                    r[0] = 1,
                    r[1] = 8 / 9 * Math.pow(2, .25),
                    r[2] = 9 / 8,
                    r[3] = Math.pow(2, .25),
                    r[4] = 8 / 9 * Math.sqrt(2),
                    r[5] = 9 / 8 * Math.pow(2, .25),
                    r[6] = Math.sqrt(2),
                    r[7] = 1.5,
                    r[8] = 128 / 81,
                    r[9] = Math.pow(8, .25),
                    r[10] = 3 / Math.pow(8, .25),
        ...
        t.MIDIjs.setMasterPitch = function(e) {
            var t = new Object;
            t.type = "set-master-pitch",
            t.frequency = e,
            se(t)
        }
        ) : "WebAudioAPI" == n ? (t.MIDIjs.pause = e,
        t.MIDIjs.resume = L,
        ...
        ) : j = "bgsound" == n ? (t.MIDIjs.play = X,
        t.MIDIjs.stop = J,
        "audioMethod: &lt;bgsound&gt;") : "object" == n ? (t.MIDIjs.play = function(e) {
            K();
            var t = document.getElementById("scorioMIDI");
            t ? t.lastChild.setAttribute("data", e) : ((t = document.createElement("div")).setAttribute("id", "scorioMIDI"),
            t.innerHTML = '<object data="' + e + '" autostart="true" volume="0" type="audio/mid"></object>',
        ...
        ,
        t.MIDIjs.stop = K,
        "audioMethod: &lt;object&gt;") : (t.MIDIjs.play = function(e) {}
        ,
        t.MIDIjs.stop = function(e) {}
        ,
        "audioMethod: No method found"),
        "Microsoft Internet Explorer" == me.browserName && "https:" == location.protocol.toLowerCase() && setTimeout(function() {
            X(G(M) + "../midi/silence.mid"),
            clearInterval(d)
        }, 1),
