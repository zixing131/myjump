...
public class Conv {
     ...
     */
    public native static int getHandler(String encoding);
     ...
     * @see #getHandler
     */
    public native static int getMaxByteLength(int handler);
     ...
     * @see #getHandler
     */
    public native static int getByteLength(int handler,
     ...
     * @see #getHandler
     */
    public native static int byteToChar(int handler,
     ...
     * @see #getHandler
     */
    public native static int sizeOfByteInUnicode(int handler,
