...
public class BufferHelper {
    ...
    public void ensureBuffer(int index, int size) {
        ...
        GLES2.bindBuffer(GLES2.Constants.GL_ARRAY_BUFFER, handles.elementAt(index));
    ...
    public void vertexFloatAttribPointer(int attr, int numPerElement, boolean normalized, int stride, int numElements, float[] elements) {
        ...
        GLES2.bufferSubData(GLES2.Constants.GL_ARRAY_BUFFER, 0, totalSize, elements);

        GLES2.vertexAttribPointer(attr, numPerElement, GLES2.Constants.GL_FLOAT, normalized, stride, 0);
    ...
    public void vertexShortAttribPointer(int attr, int numPerElement, boolean normalized, int stride, int numElements, short[] elements) {
        ...
        GLES2.vertexAttribPointer(attr, numPerElement, GLES2.Constants.GL_SHORT, normalized, stride, 0);
    ...
    public void vertexByteAttribPointer(int attr, int numPerElement, boolean unsigned, boolean normalized, int stride, int numElements, byte[] elements) {
        ...
        GLES2.vertexAttribPointer(attr, numPerElement, unsigned ? GLES2.Constants.GL_UNSIGNED_BYTE : GLES2.Constants.GL_BYTE, normalized, stride, 0);
    ...
    public void setIndexBuffer(int[] elements, int size) {
        ...
        GLES2.bindBuffer(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, indexHandle);

        // short - 2 bytes
        if (indexSize < size*2) {
            GLES2.bufferData(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, size * 8 / 3, GLES2.Constants.GL_DYNAMIC_DRAW);
        }
        ...
        GLES2.bufferSubData(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, 0, shortElements.length*2, shortElements);
    }
