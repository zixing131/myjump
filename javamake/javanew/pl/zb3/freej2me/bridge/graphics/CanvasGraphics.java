...
public class CanvasGraphics extends javax.microedition.lcdui.Graphics {
    ...
    public void setFont(Font font) {
        ...
        setFont(ctxHandle, ((CanvasFont)font.canvasFont).fontString);
    }
    ...
    private void reapplyState() {
        ...
        setFullState(ctxHandle, ((CanvasFont)font.canvasFont).fontString, strokeStyle == DOTTED, (color >> 16)&0xff, (color >> 8)&0xff, (color)&0xff, (color >> 24)&0xff, absoluteClip.x, absoluteClip.y, absoluteClip.width, absoluteClip.height, translateX, translateY);
    }
