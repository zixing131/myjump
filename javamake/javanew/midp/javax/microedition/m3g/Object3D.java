...
public abstract class Object3D {
	...
	public final int animate(int time) {
		...
		for (int i = 0; i < this.references.size(); i++) {
			Object reference = this.references.elementAt(i);
	...
	protected Object3D duplicateObject() {
		...
		try {
			var1 = (Object3D) this.duplicate();
			var1.references = new Vector();
			for (int i = 0; i < this.references.size(); i++) {
				var1.references.addElement(this.references.elementAt(i));
			}
			var1.animationTracks = new Vector();
			for (int i = 0; i < this.animationTracks.size(); i++) {
				var1.animationTracks.addElement(this.animationTracks.elementAt(i));
			}
	...
	public Object3D find(int var1) {
		if (this.userID == var1) {
			...
			for (int var3 = 0; var3 < this.references.size() && (var2 = ((Object3D) this.references.elementAt(var3)).find(var1)) == null; ++var3) {
				;
			}
		...
		if (var1 != null && var1.length < this.getReferences((Object3D[]) null)) {
			...
			if (var1 != null) {
				for (int var2 = 0; var2 < this.references.size(); ++var2) {
					var1[var2] = (Object3D) this.references.elementAt(var2);
				}
			}
	...
	public void addAnimationTrack(AnimationTrack var1) {
		if (var1 == null) {
			...
			for (int var4 = 0; var4 < this.animationTracks.size(); ++var4) {
				AnimationTrack var5;
				if ((var5 = (AnimationTrack) this.animationTracks.elementAt(var4)).getTargetProperty() > var3) {
	...
	public void removeAnimationTrack(AnimationTrack var1) {
		if (this.animationTracks.contains(var1)) {
			this.animationTracks.removeElement(var1);
	...
	protected void addReference(Object3D var1) {
		if (var1 != null) {
			this.references.addElement(var1);
		}
	}

	protected void removeReference(Object3D var1) {
		if (var1 != null) {
			this.references.removeElement(var1);
		}
	}
}
