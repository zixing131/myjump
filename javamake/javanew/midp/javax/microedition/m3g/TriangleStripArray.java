...
public class TriangleStripArray extends IndexBuffer {
	...
	public void uploadToGL() {
		if (bufferHandle != null) {
			...
			GLES2.bindBuffer(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, bufferHandle);
			return;
		}

		bufferHandle = GLES2.createBuffer();
		GLES2.bindBuffer(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, bufferHandle);
		GLES2.bufferData(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, triangles.length * 2, GLES2.Constants.GL_DYNAMIC_DRAW);
        ...
        GLES2.bufferSubData(GLES2.Constants.GL_ELEMENT_ARRAY_BUFFER, 0, buffer.length*2, buffer);
	}
}
