...
public final class MeshMorph {
	...
	private void processMorph(MorphingMesh mesh) {
		...
		setMorphVB(meshVB, mesh.getResultVb());
	...
	private void setMorphVB(VertexBuffer vb, VertexBuffer morphed) {
	...
	private void setSkinVB(VertexBuffer vb, VertexBuffer morphed) {
		this.morphed = morphed;
	...
	private void processSkinning(SkinnedMesh mesh) {
		VertexBuffer meshVB = mesh.getVertexBuffer();
		setSkinVB(meshVB, mesh.getResultVb());
