	...
	return function () {
		...
		1: [function (t, r, e) {
			...
			e.byteLength = function (t) {
				...
				for (e = 0; e < c; e += 4) {
					r = i[t.charCodeAt(e)] << 18 | i[t.charCodeAt(e + 1)] << 12 | i[t.charCodeAt(e + 2)] << 6 | i[t.charCodeAt(e + 3)], s[a++] = r >> 16 & 255, s[a++] = r >> 8 & 255, s[a++] = 255 & r;
				}
			...
			function a (t, r, e) {
				for (var i, o, f = [], u = r; u < e; u += 3) {
					i = (t[u] << 16 & 16711680) + (t[u + 1] << 8 & 65280) + (255 & t[u + 2]), f.push(n[(o = i) >> 18 & 63] + n[o >> 12 & 63] + n[o >> 6 & 63] + n[63 & o]);
				}
		...
		2: [function (t, r, e) {
			(function (r) {
				...
				r.prototype.slice = function (t, e) {
					...
					var o = i - n;
					if (this === t && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(e, n, i); else if (this === t && n < e && e < i) for (var f = o - 1; f >= 0; --f) {
						t[f + e] = this[f + n];
					...
					if (n <= e) return this;
					var f;
					if (e >>>= 0, n = void 0 === n ? this.length : n >>> 0, t || (t = 0), "number" == typeof t) for (f = e; f < n; ++f) {
						this[f] = t;
					} else {
			...
			(function (r) {
				...
				function s (t, e, n) {
					...
					if (ArrayBuffer.isView(t)) return function (t) {
						if (W(t, Uint8Array)) {
							var _r = new Uint8Array(t);

							return p(_r.buffer, _r.byteOffset, _r.byteLength);
						}
					...
					var o = function (t) {
						if (r.isBuffer(t)) {
							...
							return 0 === _e.length ? _e : (t.copy(_e, 0, 0, _r2), _e);
						}
				...
				function b (t, r, e, n) {
					...
					for (n > o / 2 && (n = o / 2), f = 0; f < n; ++f) {
						var _n4 = parseInt(r.substr(2 * f, 2), 16);
				...
				function B (t, r, e, n) {
					return V(function (t, r) {
						...
						for (var _f = 0; _f < t.length && !((r -= 2) < 0); ++_f) {
				...
				function I (t, r, e) {
					...
					for (; i < e;) {
						...
						var _o = null,
							_f2 = _r3 > 239 ? 4 : _r3 > 223 ? 3 : _r3 > 191 ? 2 : 1;
						...
						if (i + _f2 <= e) {
							...
							switch (_f2) {
								...
								case 2:
									128 == (192 & (_e4 = t[i + 1])) && (_s = (31 & _r3) << 6 | 63 & _e4) > 127 && (_o = _s);
									break;

								case 3:
									_e4 = t[i + 1], _n5 = t[i + 2], 128 == (192 & _e4) && 128 == (192 & _n5) && (_s = (15 & _r3) << 12 | (63 & _e4) << 6 | 63 & _n5) > 2047 && (_s < 55296 || _s > 57343) && (_o = _s);
									break;

								case 4:
									_e4 = t[i + 1], _n5 = t[i + 2], _u = t[i + 3], 128 == (192 & _e4) && 128 == (192 & _n5) && 128 == (192 & _u) && (_s = (15 & _r3) << 18 | (63 & _e4) << 12 | (63 & _n5) << 6 | 63 & _u) > 65535 && _s < 1114112 && (_o = _s);
							}
						}
				...
				e.kMaxLength = f, r.TYPED_ARRAY_SUPPORT = function () {
					...
					for (var _r5 = 0, _o2 = Math.min(n, i); _r5 < _o2; ++_r5) {
						if (t[_r5] !== e[_r5]) {
							n = t[_r5], i = e[_r5];
							break;
						}
					...
					for (n = 0; n < t.length; ++n) {
						var _e5 = t[n];
						if (W(_e5, Uint8Array)) o + _e5.length > i.length ? (r.isBuffer(_e5) || (_e5 = r.from(_e5)), _e5.copy(i, o)) : Uint8Array.prototype.set.call(i, _e5, o); else {
							if (!r.isBuffer(_e5)) throw new TypeError('"list" argument must be an Array of Buffers');
				...
				function L (t, r, e) {
					...
					for (var _t3 = 0; _t3 < n.length - 1; _t3 += 2) {
				...
				r.prototype.slice = function (t, e) {
					...
					if (t = +t, r >>>= 0, !n) {
						var _n7 = Math.pow(2, 8 * e - 1);

						O(this, t, r, e, _n7 - 1, -_n7);
					}
					...
					if (t = +t, r >>>= 0, !n) {
						var _n8 = Math.pow(2, 8 * e - 1);

						O(this, t, r, e, _n8 - 1, -_n8);
					}
					...
					if ("string" == typeof t) {
						...
						if (1 === t.length) {
							var _r9 = t.charCodeAt(0);

							("utf8" === i && _r9 < 128 || "latin1" === i) && (t = _r9);
						}
					...
					if (e >>>= 0, n = void 0 === n ? this.length : n >>> 0, t || (t = 0), "number" == typeof t) for (o = e; o < n; ++o) {
						...
						if (0 === _u2) throw new TypeError('The value "' + t + '" is invalid for argument "value"');
				...
				function F (t, r, e, n, i, o) {
					if (t > e || t < r) {
						var _n9 = "bigint" == typeof r ? "n" : "";

						var _i3;

						throw _i3 = o > 3 ? 0 === r || r === BigInt(0) ? `>= 0${_n9} and < 2${_n9} ** ${8 * (o + 1)}${_n9}` : `>= -(2${_n9} ** ${8 * (o + 1) - 1}${_n9}) and < 2 ** ` + `${8 * (o + 1) - 1}${_n9}` : `>= ${r}${_n9} and <= ${e}${_n9}`, new k.ERR_OUT_OF_RANGE("value", _i3, t);
					}
				...
				$("ERR_BUFFER_OUT_OF_BOUNDS", function (t) {
					...
					var n = `The value of "${t}" is out of range.`,
						i = e;
					return Number.isInteger(e) && Math.abs(e) > Math.pow(2, 32) ? i = j(String(e)) : "bigint" == typeof e && (i = String(e), (e > Math.pow(BigInt(2), BigInt(32)) || e < -Math.pow(BigInt(2), BigInt(32))) && (i = j(i)), i += "n"), n += ` It must be ${r}. Received ${i}`;
				}, RangeError);
				var Y = /[^+\/0-9A-Za-z-_]/g;
				...
				var J = function () {
					...
					for (var _r10 = 0; _r10 < 16; ++_r10) {
						var _e6 = 16 * _r10;

						for (var _n10 = 0; _n10 < 16; ++_n10) {
							t[_e6 + _n10] = "0123456789abcdef"[_r10] + "0123456789abcdef"[_n10];
						}
					}
